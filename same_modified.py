...
#
# Nikita Puchkin
# Modified structure-adaptive manifold estimator (SAME+)
...
def SAME_plus(Y, n_neighbors_list):
    ...
    #
    # adaptive choice of the threshold tau
    dist_sorted = np.sort(dist[0])
    tau = dist_sorted[n_neighbors_list[0]]
